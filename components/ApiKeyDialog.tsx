    ...
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 border border-gray-700 rounded-2xl shadow-xl max-w-lg w-full p-8 text-center flex flex-col items-center">
        ...
        <p className="text-gray-300 mb-6">
          The Google AI models used in this app (Veo for video, TTS for audio, and certain image models) are paid-only. To use the Gemini features, please select an API key associated with a paid Google Cloud project that has billing enabled.
        </p>
