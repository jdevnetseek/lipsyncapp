...
// Note: These functions are adapted from the Gemini API documentation for handling raw audio data.
...
export async function decodeAudioData(
  ...
  // The API returns raw PCM data, so we interpret it as 16-bit signed integers.
